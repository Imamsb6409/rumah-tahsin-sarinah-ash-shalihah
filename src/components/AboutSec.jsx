...
export default function AboutSec() {
  return (
    <section id="about" className="bg-primary h-screen text-head p-4 flex flex-col md:flex-row justify-center md:justify-around items-center gap-y-4 md:items-start  relative overflow-hidden">
      ...
      {/* --- BAGIAN MARQUEE --- */}
      <div className="z-10 flex flex-row md:flex-col gap-4 overflow-hidden h-full max-h-220 mt-11">
        <div className="flex flex-row md:flex-col px-2 gap-4 animate-marquee md:animate-marquee-vertical">
          {/* Mapping Pertama */}
